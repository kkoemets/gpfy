...
import { getCachedContractByName, setCachedContractByName } from '../../../src/process/cache/token.cache.manager';
...
describe('tokenCacheManager', function () {
    ...
    it('Set and get', async function () {
        ...
        expect(await getCachedContractByName({ coinOfficialName })).to.be.equal(contract);
    });
});
